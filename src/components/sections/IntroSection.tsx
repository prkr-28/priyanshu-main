    ...
    <section className="min-h-screen relative flex flex-col justify-center items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-40">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <motion.div
                ...
                className={`inline-flex items-center px-3 py-1.5 rounded-full ${theme === "retro"
            ...
            >
              ...
              <div className={`flex items-start space-x-3 p-3 rounded-xl backdrop-blur-sm ${theme === "retro"
                ...
                <p className={`text-sm sm:text-base ${theme === "retro"
                  ...
                  Active in open source, mentoring, and sharing learnings through concise technical content.
            ...
            >
              <Link
                href="https://x.com"
                target="_blank"
                className={`p-2.5 rounded-full transition-all duration-300 hover:scale-110 ${theme === "retro"
            ...
            >
              <Button
                className={`w-full max-w-[200px] py-2 rounded-full transition-all duration-500 group relative overflow-hidden ${theme === "retro"
              ...
              >
                <span className={`absolute inset-0 w-full h-full transition-all duration-500 opacity-0 group-hover:opacity-100 ${theme === "retro"
          ...
          >
            <div className={`w-[240px] h-[240px] rounded-3xl overflow-hidden ${theme === 'retro'
